...
let PersonalService = class PersonalService {
    ...
    cargoRepository;
    deptoRepository;
    constructor(empleadoRepository, rolRepository, cargoRepository, deptoRepository) {
    ...
    async deleteEmpleado(empresaId, empleadoId) {
        console.log(`Microservicio PERSONAL: Desactivando (Soft Delete) empleado ${empleadoId} para empresaId: ${empresaId}`);
        const empleado = await this.empleadoRepository.findOneBy({
            id: empleadoId,
            empresaId: empresaId,
        });
...
exports.PersonalService = PersonalService = __decorate([
    ...
    __param(3, (0, typeorm_1.InjectRepository)(database_1.Departamento)),
