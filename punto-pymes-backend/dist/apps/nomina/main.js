...
const create_solicitud_dto_1 = __webpack_require__(/*! ./dto/create-solicitud.dto */ "./apps/nomina/src/dto/create-solicitud.dto.ts");
let NominaService = class NominaService {
    ...
    async solicitarVacaciones(empresaId, dto) {
        ...
        const tipoSolicitud = dto.tipo || create_solicitud_dto_1.TipoSolicitud.VACACIONES;
        if (tipoSolicitud === create_solicitud_dto_1.TipoSolicitud.VACACIONES) {
            ...
            if (diasDisponibles < diasSolicitados) {
                throw new common_1.BadRequestException(`Saldo insuficiente. Tienes ${diasDisponibles} días y pides ${diasSolicitados}.`);
            }
        }
        else {
            if (!dto.comentario || dto.comentario.length < 5) {
                throw new common_1.BadRequestException('Para este tipo de ausencia, la justificación es obligatoria.');
            }
        }
